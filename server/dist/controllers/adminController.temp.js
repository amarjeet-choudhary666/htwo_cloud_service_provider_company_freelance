...
exports.adminController = {
    ...
    async dashboard(_req, res) {
        try {
            ...
            const recentSubmissions = []; // Empty for now
    ...
    async getDemoRequests(_req, res) {
        try {
    ...
    async getContactForms(_req, res) {
        try {
    ...
    async getInTouchForms(_req, res) {
        try {
    ...
    async bulkDeleteSubmissions(_req, res) {
        res.status(404).json({ success: false, message: 'Form submissions not available yet. Please run Prisma migration.' });
    },
    async bulkUpdateStatus(_req, res) {
        res.status(404).json({ success: false, message: 'Form submissions not available yet. Please run Prisma migration.' });
    }
};
//# sourceMappingURL=adminController.temp.js.map